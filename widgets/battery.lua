...
local function worker(user_args)
    ...
    watch("acpi -i", timeout,
        function(widget, stdout)
            ...
            elseif (charge >= 15 and charge <= 20) then batteryType = "battery%s-20"
            elseif (charge >= 20 and charge <= 30) then batteryType = "battery%s-30"
            elseif (charge >= 30 and charge <= 40) then batteryType = "battery%s-40"
            elseif (charge >= 40 and charge <= 50) then batteryType = "battery%s-50"
            elseif (charge >= 50 and charge <= 60) then batteryType = "battery%s-60"
            elseif (charge >= 60 and charge <= 70) then batteryType = "battery%s-70"
            elseif (charge >= 70 and charge <= 80) then batteryType = "battery%s-80"
            elseif (charge >= 80 and charge <= 90) then batteryType = "battery%s-90"
            elseif (charge >= 90 and charge <= 100) then batteryType = "battery%s-100"
            end
